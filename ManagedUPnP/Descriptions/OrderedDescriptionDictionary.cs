...
namespace ManagedUPnP.Descriptions
{
    ...
    public abstract class OrderedDescriptionDictionary<TKey, TValue> : Description, IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        /// </summary>
        protected OrderedIndexedDictionary<TKey, TValue> mdDictionary = new OrderedIndexedDictionary<TKey, TValue>();
        ...
        /// </summary>
        public OrderedDescriptionDictionary(Description parent)
            : base(parent)
        {
        }
        ...
        public OrderedDescriptionDictionary(Description parent, XmlTextReader reader)
            : this(parent)
        {
            AddItemsFrom(reader);
        }
        ...
        public TValue this[int index]
        {
            get
            {
                return mdDictionary.PairAt(index).Value;
            }
        }
