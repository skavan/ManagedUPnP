...
namespace ManagedUPnP.Descriptions
{
    ...
    public abstract class FormattedDescriptionDictionary<TKey, TValue> : 
        DescriptionDictionary<TKey, TValue> where TValue : Description
    {
        ...
        public FormattedDescriptionDictionary(Description parent)
            : base(parent)
        {
        }
        ...
        public FormattedDescriptionDictionary(Description parent, XmlTextReader reader)
            : base(parent, reader)
        {
        }
